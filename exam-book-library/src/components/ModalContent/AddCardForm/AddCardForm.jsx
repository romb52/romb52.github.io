...
export default function AddVisitorForm() {
    ...
    const initialForm = { id: 0, visitorId: 0, bookId: 0, visitor: "", book: books.length > 0 ? books[0].title : "", borrowDate: "", returnDate: "" };
    const dispatch = useDispatch();
    const [form, setForm] = useState(initialForm);
   // const [visitorField, setVisitorField] = useState(''); // Стан для зберігання вибраного поля сортуванн
  //  const [bookField, setBookField] = useState(''); // Стан для зберігання вибраного поля сортуван
    ...
    // const sortChange = (e) => {
    //     setVisitorField(e.target.value); // Оновлення поля сортування при зміні вибору
    //   };
